...
def parse_commit_tree(json_data: dict, commit_sha: str, repo_name: str):
    """Parsea el AST inyectando métricas geométricas y normalizando anchos dinámicamente."""
    try:
    ...
    # PASO CLAVE: Encontrar la regla más larga en ESTE COMMIT para normalizar
    max_rule_len = 1
    ...
    for cat in doc.rootNode.children:
        ...
        for label in cat.children:
            ...
            for rule in label.children:
                ...
                # NORMALIZACIÓN DINÁMICA RELATIVA: Mapeo exacto basado en el máximo del commit [180px - 550px]
                min_w = 180
                max_w = 550
                ...
                label_node["children"].append({
                    ...
                    "width": dyn_width, # <--- El ancho ahora es altamente dinámico y relativo
...
<head>
    ...
    <style>
        ...
        .node-added rect.main-rect {{ stroke: #10b981 !important; stroke-width: 4px !important; filter: drop-shadow(0 0 6px rgba(16,185,129,0.5)); }}
